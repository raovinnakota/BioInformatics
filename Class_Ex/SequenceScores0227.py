"""
Sequence Scores
02/27 In Class Exercise
Rao Vinnakota
"""

#dictionaries for sequences scores:
...
def sequence_identity(seq1, seq2):
    ...
    for (i,a) in zip(seq1, seq2):
        if ((i not in bases) or (a not in bases)):
...
def sequence_score(seq1, seq2):
    insertion_flag = 0
    bases = ['A', 'T', 'C', 'G', 'N', '-']
    
sequence_identity('AATATTCG', 'AGTTTAGC')
